        ...
        <Row>
          <div className='nav__wrapper'>
            ...
            <div className="nav__icons">
              ...
              <span className="cart__icon" onClick={navigatorToCart}><i className="ri-shopping-bag-line"></i>
              ...
              <div className='profile'>
                ...
                {
              currentUser ? <span onClick={logout}>Logout</span> : <div className='d-flex align-items-center justify-conten-center flex-column'>
