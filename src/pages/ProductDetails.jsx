      ...
      <section>
        <Container>
          <Row>
            <Col lg='12'>
...

              {
                tab === 'desc' ? (
                  ...
                  <div className='reviews__review mt-5'>
                    <div className="review__wrapper">
                      ...
                      <div className="review__form">
                        <h1>Leaver your experience</h1>
                        <form action="" onSubmit={submitHandler}>
                          <div className="form__group"><input type="text" placeholder='Enter name' ref={reviewUser} required /></div>
                          ...
                          <div className="form__group"><textarea ref={reviewMsg} rows={4} type="text" placeholder='Review Massage.....' required /></div>
            ...
            <h2 className="related__little">You might also like </h2>
            </Col>
